...
This README provides instructions on how to use the various bash scripts to more efficiently use STEVE External API. These scripts are meant to eliminate the need to switch back and forth between the Swagger UI and command line:
